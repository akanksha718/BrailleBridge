  ...
  return (
    <div>
      <form onSubmit={onsubmit}>
        ...
        <Button disabled={isBtnDisabled} type='submit' className='mt-2 w-full bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700'>{buttonText || 'Submit'}</Button>
      </form>
    </div>
  )
}
